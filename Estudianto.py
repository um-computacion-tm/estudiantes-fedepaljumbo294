class Persona:
    def _init_(self, param_nombre, param_email):
...
class Profesor(Persona):
    def _init_(self, param_nombre, param_email, legajo_empleado):
        self.legajo_empleado = legajo_empleado
        super()._init_(param_nombre, param_email)

class Alumno(Persona):
    def _init_(self, param_nombre, param_email, numero_alumno):
